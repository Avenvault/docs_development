...
Um die API für den Bot zu erhalten, musst du in deiner `pom.xml` haben

Fügen Sie dies in Ihr Projekt ein:
...
Du findest die neueste Version [here](https://maven.plugins.avenvault.com/) unter AeroDesk-API
