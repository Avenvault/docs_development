...
- [Посібник розробника API AeroDesk](addons-api/aerodesk-developer-api-guide/README.md)
  - [Почив](addons-api/aerodesk-developer-api-guide/getting-started.md)
  - [Базовий API](addons-api/aerodesk-developer-api-guide/base-api.md)
  - [Ключові слова FAQs і рівень масштабування](addons-api/aerodesk-developer-api-guide/keyword-faqs-and-escalation-levels.md)
  - [Метод синхронізації бази даних і конфігурації](addons-api/aerodesk-developer-api-guide/database-and-config-sync-methods.md)
  - [Categories & Support Tiers](addons-api/aerodesk-developer-api-guide/categories-and-support-tiers.md)
  - [Сторінка 4](addons-api/aerodesk-developer-api-guide/page-4.md)
